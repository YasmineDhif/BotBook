...
// Vérifie si l'utilisateur n'est pas connecté, redirige vers la page de connexion
if (!isset($_SESSION["user_id"])) {
    header("Location: pconnexion.php");
    exit();
}

// fonction pour récupérer la liste des contacts de l'utilisateur
        ...
        <tbody>
            <?php foreach ($contacts as $donnees) : ?>
                ...
                <tr>
                    ...
                    <!-- Liens pour modifier et supprimer le contact -->
                    <td>
